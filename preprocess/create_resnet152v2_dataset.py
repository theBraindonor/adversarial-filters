...
"""
    ...
    by the Resnet152V2 classifier.  The number of images to collect and the random seed will be configurable from
...
if __name__ == '__main__':
    dataset_creator = DatasetCreator('resnet152v2', ResNet152V2, preprocess_input, decode_predictions)
