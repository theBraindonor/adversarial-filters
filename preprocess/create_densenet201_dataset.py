...
"""
    ...
    by the DenseNet201 classifier.  The number of images to collect and the random seed will be configurable from
...
if __name__ == '__main__':
    dataset_creator = DatasetCreator('densenet201', DenseNet201, preprocess_input, decode_predictions)
