...
"""
    ...
    by the VGG16 classifier.  The number of images to collect and the random seed will be configurable from
...
if __name__ == '__main__':
    dataset_creator = DatasetCreator('vgg16', VGG16, preprocess_input, decode_predictions)
