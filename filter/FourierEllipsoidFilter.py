...
"""
    This file defines a fourier ellipsoid filter that can be used in experiments and evaluations.
"""
...
class FourierEllipsoidFilter(object):
    """
    ...
    def get_dimensions():
        return [
            Real(low=1.0, high=50., name='size')
        ]
