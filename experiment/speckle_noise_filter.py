...
"""
    Test the impact of a speckle noise filter on several imagenet based classifiers.
"""
...
if __name__ == '__main__':
    ...
    if NETWORK == 'vgg16':
        ...
        save_filter_search_scores(filter, results, scores, 'log/speckle_noise_filter_vgg16_%s_search.csv' % SAMPLE)
    ...
    if NETWORK == 'vgg19':
        ...
        results, scores = search.perform_search(iterations=ITERATIONS)
        save_filter_search_scores(filter, results, scores, 'log/speckle_noise_filter_vgg19_%s_search.csv' % SAMPLE)
    ...
    if NETWORK == 'densenet':
        ...
        results, scores = search.perform_search(iterations=ITERATIONS)
        save_filter_search_scores(filter, results, scores, 'log/speckle_noise_filter_densenet201_%s_search.csv' % SAMPLE)
    ...
    if NETWORK == 'resnet':
        ...
        results, scores = search.perform_search(iterations=ITERATIONS)
        save_filter_search_scores(filter, results, scores, 'log/speckle_noise_filter_resnet152v2_%s_search.csv' % SAMPLE)
